...
from vivarium_csu_sanofi_multiple_myeloma.constants import data_keys, metadata
from vivarium_csu_sanofi_multiple_myeloma.utilities import sanitize_location, delete_if_exists, len_longest_location
from vivarium_csu_sanofi_multiple_myeloma.tools.app_logging import add_logging_sink, decode_status
...
def build_single_location_artifact(path: Union[str, Path], location: str, log_to_file: bool = False):
    ...
    from vivarium_csu_sanofi_multiple_myeloma.data import builder
