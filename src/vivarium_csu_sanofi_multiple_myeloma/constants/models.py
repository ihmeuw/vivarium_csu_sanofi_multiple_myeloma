...
MULTIPLE_MYELOMA_STATE_NAME = MULTIPLE_MYELOMA_MODEL_NAME
MULTIPLE_MYELOMA_MODEL_STATES = (SUSCEPTIBLE_STATE_NAME, MULTIPLE_MYELOMA_STATE_NAME)
MULTIPLE_MYELOMA_MODEL_TRANSITIONS = (
    TransitionString(f'{SUSCEPTIBLE_STATE_NAME}_TO_{MULTIPLE_MYELOMA_STATE_NAME}'),
)
