...
MULTIPLE_MYELOMA_WITH_CONDITION_STATES = (
    MULTIPLE_MYELOMA_1_STATE_NAME,
    MULTIPLE_MYELOMA_2_STATE_NAME,
    MULTIPLE_MYELOMA_3_STATE_NAME,
    MULTIPLE_MYELOMA_4_STATE_NAME,
    MULTIPLE_MYELOMA_5_STATE_NAME,
)
MULTIPLE_MYELOMA_MODEL_STATES = (SUSCEPTIBLE_STATE_NAME,) + MULTIPLE_MYELOMA_WITH_CONDITION_STATES
